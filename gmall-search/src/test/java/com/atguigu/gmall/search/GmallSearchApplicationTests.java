...
class GmallSearchApplicationTests {
    ...
    public void importData(){
        ...
        do {
            ...
            Resp<List<SpuInfoEntity>> listResp = this.gmallPmsClient.querySpuInfoByStatus(condition,1);
            // 获取当前页的spuInfo数据
    ...
    void contextLoads() throws IOException {
        ...
        //向索引库中添加数据
        /*Index index = new Index.Builder(new User("liuyan1", "123456", 18)).index("user").type("info").id("1").build();
