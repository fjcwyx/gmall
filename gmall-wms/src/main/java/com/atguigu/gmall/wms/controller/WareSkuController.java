...
public class WareSkuController {
    ...
    @GetMapping("{skuId}")
    public Resp<List<WareSkuEntity>> queryWareSkuEntitys(@PathVariable("skuId") Long skuId){
        List<WareSkuEntity> WareSkuEntitys =  this.wareSkuService.list(new QueryWrapper<WareSkuEntity>().eq("sku_id", skuId));
        return  Resp.ok(WareSkuEntitys);
    }
