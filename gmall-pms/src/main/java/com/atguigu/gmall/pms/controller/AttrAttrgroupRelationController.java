...
public class AttrAttrgroupRelationController {
    ...
    public Resp<String> deleteAttr(@RequestBody List<AttrAttrgroupRelationEntity> attrRelations){

        this.attrAttrgroupRelationService.remove(new QueryWrapper<AttrAttrgroupRelationEntity>().eq("attr_group_id", attrRelations.get(0).getAttrGroupId()).eq("attr_id", attrRelations.get(0).getAttrId()));
        return Resp.ok("删除成功");
    }
